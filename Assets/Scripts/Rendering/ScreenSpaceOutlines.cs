/*
 * This script was copied from Gtihub to achieve an outline rendering effect on certain objects
 * Credit to Robin Seibold
 * Repo: https://github.com/Robinseibold/Unity-URP-Outlines 
 * YouTube Tutorial (Outdated API used for this version of Unity/URP): https://youtu.be/LMqio9NsqmM?si=LSfeyiGg3DhKhs-J
 */
...
public class ScreenSpaceOutlines : ScriptableRendererFeature {
    ...
    private class ScreenSpaceOutlinePass : ScriptableRenderPass {
        ...
        public ScreenSpaceOutlinePass(RenderPassEvent renderPassEvent, LayerMask layerMask,
            ...
            screenSpaceOutlineMaterial = new Material(Shader.Find("Hidden/OutlinesShader"));
